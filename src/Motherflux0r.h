...
#define TOUCH_DWELL_LONG_PRESS        800  // Milliseconds for "long-press".
#define E_VAL                      1.0184
...
#define CHKLST_BOOT_MASK_SHUTDOWN_COMPLETE ( \
  CHKLST_BOOT_DEINIT_TOUCH | CHKLST_BOOT_DEINIT_GPIO | CHKLST_BOOT_DEINIT_UI | \
  CHKLST_BOOT_DEINIT_SPI0 | CHKLST_BOOT_DEINIT_I2C0 | CHKLST_BOOT_DEINIT_I2C1 | \
  CHKLST_BOOT_DEINIT_HANGUP | CHKLST_BOOT_DEINIT_MAG_GPIO | CHKLST_BOOT_DEINIT_PMU_SAFE | \
  CHKLST_BOOT_DEINIT_DISPLAY | CHKLST_BOOT_DEINIT_UARTS | CHKLST_BOOT_DEINIT_CONF_SAVE)
